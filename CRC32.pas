...
function CalculateCRC32File(Filename: string): Cardinal;
function CalculateCRC32String(str: string): Cardinal;

implementation

// Quelle: https://www.experts-exchange.com/questions/24971308/How-can-I-calculate-CRC32-from-a-String-in-Delphi.html
...
begin
  ...
  try
    result := CalculateCRC32(FileStream);
  finally
    FileStream.Free;
  end;
end;
...
begin
  ...
  try
    result := CalculateCRC32(StrStream);
  finally
    StrStream.Free;
  end;
end;
